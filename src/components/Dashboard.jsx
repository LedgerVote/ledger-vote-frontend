...
<div className="p-4 sm:ml-64 h-screen flex items-center justify-center">
   ...
   <div className=" w-full bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 p-6 overflow-y-auto">
            <div className="mb-6">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Create New Item</h2>
              ...
              <form className="space-y-4">
                ...
                {/* Votes Input */}
                <div>
                  <label htmlFor="votes" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Votes</label>
                  <input 
                    type="number" 
                    id="votes" 
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" 
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <p className="text-sm text-gray-600 dark:text-gray-300">Item "Project Plan" was updated</p>
